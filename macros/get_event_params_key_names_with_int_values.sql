{% macro get_key_names_with_int_values() %}
...
from int_values
where event_parameter_value = "int" and event_parameter_key not like '%_id' and event_parameter_key not in ("click_text","link_text","search_term","tax","value","wct_conversion","link_domain","coupon")
